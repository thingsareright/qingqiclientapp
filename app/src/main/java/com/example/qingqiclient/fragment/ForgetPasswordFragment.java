...
public class ForgetPasswordFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //在onCreate的方法里对SDK进行初始化，我们这里已经在Manifest里面进行过配置了，所以不用再初始化了
                    ...
                    if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendRegisterWithOkHttp(Constant.getServer() + "/user/forgetpassword?tel=" + usertel.getText().toString() +
                    ...
                    if (responseData.equals("1")){
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent intent = new Intent(ForgetPasswordFragment.this.getActivity(),All_EI_Info.class);
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(getContext(), "更改密码失败", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                } catch (IOException e) {
